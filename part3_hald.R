...
#' Also note that positions of hydro idx 32 and 70 are uncertain, so they should be estimated, i.e. removed from the fixed_hydros_idx vector. These settings should give a good sync model
#' 
## ----eval=FALSE---------------------------------------------------------------------------------------------------------------------------------------------------
